            ...
            <div class="row">
                <div class="col-12">
                    <div class="filter-section mb-5">
                        <h3 class="filter-title mb-4">Filter Berdasarkan Kategori</h3>
                        <div class="filter-buttons">
                            <button class="filter-btn active" data-filter="all">Semua</button>
                            <button class="filter-btn" data-filter="jersey">Jersey</button>
                            <button class="filter-btn" data-filter="pdlpdh">PDL/PDH</button>
                            <button class="filter-btn" data-filter="hoodiejaket">Hoodie & Jaket</button>
                        </div>
                    </div>
                </div>
            </div>
